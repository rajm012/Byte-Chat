...
/** Small inline badge showing live online member count for a group */ function GroupOnlineBadge(t0) {
    ...
    if ($[0] !== "aa48b1e7f4cef863081063adef3ab712f080754d9dc6ed4989a5f63539d1cfa5") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "aa48b1e7f4cef863081063adef3ab712f080754d9dc6ed4989a5f63539d1cfa5";
    }
    const { groupId } = t0;
    ...
    const fetchAndDecryptConversationKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MyGroupsPage.useCallback[fetchAndDecryptConversationKey]": async (msgs_0)=>{
            try {
                ...
                const hasEncryptedMessages = msgs_0.some({
                    "MyGroupsPage.useCallback[fetchAndDecryptConversationKey].hasEncryptedMessages": (m_1)=>m_1.encrypted_content && m_1.content_iv && m_1.content_auth_tag
                }["MyGroupsPage.useCallback[fetchAndDecryptConversationKey].hasEncryptedMessages"]);
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "w-full py-3 px-4 rounded-xl h-11 bg-linear-to-r from-[#87ceeb]/30 to-[#ffb6c1]/30 dark:from-[#0c6780]/30 dark:to-[#4a6368]/30 animate-pulse"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/my-groups/page.tsx",
                                                lineNumber: 468,
                                                columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                className: `w-10 h-10 rounded-xl flex items-center justify-center transition-colors ${showMoreOptions ? 'bg-[#87ceeb]/30 text-[#0c6780]' : 'bg-white/50 dark:bg-[#004040]/50 text-[#6f787d] dark:text-[#bfc8cd] hover:bg-[#87ceeb]/20 dark:hover:bg-[#0c6780]/30'}`,
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "material-symbols-outlined",
                                                                    children: "add"
                                                                }, void 0, false, {
                                                            ...
                                                            showMoreOptions && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "absolute bottom-full left-0 mb-2 bg-white/95 dark:bg-[#004040]/95 backdrop-blur-xl rounded-xl p-2 shadow-xl border border-white/30 dark:border-[#004a4a]/30 z-50 flex flex-col gap-1 min-w-11",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        type: "button",
                                                                        onClick: ()=>{
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        type: "button",
                                                                        onClick: ()=>{
                                                                            setShowPollTypeMenu(!showPollTypeMenu);
                                                                            setShowMoreOptions(false);
                                                                        },
                                                                        className: `w-10 h-10 rounded-lg flex items-center justify-center transition-colors ${showPollTypeMenu ? 'bg-[#87ceeb]/30 text-[#0c6780]' : 'bg-white/50 dark:bg-[#004040]/50 text-[#6f787d] dark:text-[#bfc8cd] hover:bg-[#87ceeb]/20 dark:hover:bg-[#0c6780]/30'}`,
                                                                        title: "Create poll",
                                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            className: "material-symbols-outlined text-sm",
                                                                            children: "poll"
...
_s1(MyGroupsPage, "JwL+zjdwAmTkXXnPulqksG+TQbk=", false, function() {
    return [
