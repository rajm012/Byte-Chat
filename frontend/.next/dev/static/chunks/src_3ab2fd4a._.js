...
function useDarkMode() {
    ...
    if ($[0] !== "2785b62fb4d7f7fd5d4125565cb0ad51bc075e4264ad4806a8da83bd3904fd5d") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2785b62fb4d7f7fd5d4125565cb0ad51bc075e4264ad4806a8da83bd3904fd5d";
    }
...
function DashboardPage() {
    ...
    const { notifications, count: notificationCount, markRead, deleteOne, refresh } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
    ...
    const [, setMyGroups] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [filterBranch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const [filterGender] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const [filterYear] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    ...
    const normalizeCurrentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[normalizeCurrentUser]": (raw)=>{
    ...
    }["DashboardPage.useCallback[normalizeCurrentUser]"], []);
    ...
    const fetchCurrentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[fetchCurrentUser]": async ()=>{
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    if (data_0.success && data_0.data) {
                        const normalized = normalizeCurrentUser(data_0.data);
    ...
    }["DashboardPage.useCallback[fetchCurrentUser]"], [
    ...
    const fetchData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[fetchData]": async ()=>{
            try {
                const userRaw_0 = localStorage.getItem('user');
                let currentUserId = null;
                let currentUserRollNo = null;
                if (userRaw_0) {
                    try {
                        const parsed = JSON.parse(userRaw_0);
                ...
                // Fetch users
                const { API_BASE_URL: API_BASE_URL_0 } = await __turbopack_context__.A("[project]/src/services/apiBase.ts [app-client] (ecmascript, async loader)");
                const usersResponse = await fetch(`${API_BASE_URL_0}/api/profile/all`, {
                    credentials: 'include'
                });
                if (usersResponse.status === 401) {
                    setError('Please login to continue');
                    setTimeout({
                        "DashboardPage.useCallback[fetchData]": ()=>router.push('/login')
                    }["DashboardPage.useCallback[fetchData]"], 1500);
                    return;
                }
                const usersData = await usersResponse.json();
                if (usersData.success && usersData.data && Array.isArray(usersData.data.users)) {
                    const visibleUsers = usersData.data.users.filter({
                        "DashboardPage.useCallback[fetchData].visibleUsers": (user)=>{
                    ...
                    }["DashboardPage.useCallback[fetchData].visibleUsers"]);
                    setUsers(visibleUsers);
                }
                // Fetch my groups to filter them out from public groups
                const myGroupsData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$group$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["groupService"].getMyGroups();
                const myGroupIds = new Set();
                if (myGroupsData.success && myGroupsData.data && Array.isArray(myGroupsData.data.groups)) {
                    setMyGroups(myGroupsData.data.groups);
                    myGroupsData.data.groups.forEach({
                        "DashboardPage.useCallback[fetchData]": (g)=>myGroupIds.add(g.group_id)
                    }["DashboardPage.useCallback[fetchData]"]);
                }
                // Fetch public groups and filter out groups user is already a member of
                const groupsData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$group$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["groupService"].getPublicGroups();
                if (groupsData.success && groupsData.data && Array.isArray(groupsData.data.groups)) {
                    // Only show groups user hasn't joined yet
                    const nonMemberGroups = groupsData.data.groups.filter({
                        "DashboardPage.useCallback[fetchData].nonMemberGroups": (g_0)=>!myGroupIds.has(g_0.group_id)
                    }["DashboardPage.useCallback[fetchData].nonMemberGroups"]);
    ...
    const filteredUsers = users.filter((user_0)=>{
        const matchesSearch = user_0.name.toLowerCase().includes(searchQuery.toLowerCase()) || user_0.roll_no.toLowerCase().includes(searchQuery.toLowerCase());
        const matchesBranch = filterBranch === 'all' || user_0.branch === filterBranch;
        const matchesGender = filterGender === 'all' || user_0.gender === filterGender;
        const matchesYear = filterYear === 'all' || user_0.roll_no?.toLowerCase().includes(filterYear.toLowerCase());
    ...
    const handleJoinGroup = async (groupId, isAnonymous_0 = false)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$group$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["groupService"].joinGroup(groupId, isAnonymous_0);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    ...
                    activeTab === 'users' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3",
                                children: filteredUsers.map((user_1, index_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    user_1.dp_url ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        src: user_1.dp_url,
                                                        alt: user_1.name,
                                                        fill: true,
                                                    ...
                                                    index_0 % 5 === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    index_0 % 7 === 3 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                onClick: ()=>handleStartChat(user_1.user_id, false),
                                                                disabled: navigating,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                onClick: ()=>handleStartChat(user_1.user_id, true),
                                                                disabled: navigating,
                    ...
                    activeTab === 'groups' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3",
                                children: filteredGroups.map((group_0, index_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "group relative flex flex-col bg-surface-container-lowest rounded-lg overflow-hidden transition-all duration-500 hover:shadow-[0_20px_40px_-10px_rgba(0,32,32,0.15)] hover:-translate-y-1",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "aspect-square overflow-hidden relative",
                                                children: [
                                                    group_0.group_dp_url ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        src: group_0.group_dp_url,
                                                        alt: group_0.group_name,
                                                        fill: true,
                                                        className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-110",
                                                        priority: index_1 < 6
                                                    }, void 0, false, {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            ...
                                                            children: group_0.group_name.charAt(0).toUpperCase()
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/dashboard/page.tsx",
                                                            lineNumber: 617,
                                                            columnNumber: 25
                                                    ...
                                                    index_1 % 5 === 2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "absolute top-2 right-2 w-4 h-4 bg-tertiary/30 rounded-full blur-sm"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/page.tsx",
                                                        lineNumber: 620,
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                onClick: ()=>handleJoinGroup(group_0.group_id, false),
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                onClick: ()=>handleJoinGroup(group_0.group_id, true),
            ...
            showCreateGroup && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CreateGroupModal, {
...
_s1(DashboardPage, "FmNcnmnCrXpFor991M7n+m+O80k=", false, function() {
    return [
...
function CreateGroupModal({ onClose, onSuccess }) {
    ...
    const handleSubmit = async (e_0)=>{
        ...
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$group$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["groupService"].createGroup(formData);
            const groupId = result.data?.group?.group_id;
            // Upload image if selected
            if (groupId && selectedImage) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$image$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadGroupPicture"])(groupId, selectedImage);
                } catch (uploadError) {
            ...
            console.error('Failed to create group', error_0);
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            onChange: (e_3)=>setFormData({
                                                    ...formData,
                                                    max_members: parseInt(e_3.target.value)
                                                }),
                                            className: "input-romance"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/dashboard/page.tsx",
...
_s2(CreateGroupModal, "nGvF7CXsZwgvGm/ATPN3mWrMyTg=");
...
//# sourceMappingURL=src_3ab2fd4a._.js.map