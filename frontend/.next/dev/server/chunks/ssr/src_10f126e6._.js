...
"[project]/src/app/chat/new/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewChatPage() {
    ...
    const [searchParamsObj, setSearchParamsObj] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [status, setStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('sending');
    ...
    const requestSentRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(false);
    const sendRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (receiverId, isAnonymous)=>{
        try {
            setStatus('sending');
            setError('');
            // Add timeout handler (15 seconds)
            const timeoutPromise = new Promise((_, reject)=>setTimeout(()=>reject(new Error('Request timeout. Please try again.')), 15000));
            // Use the appropriate service based on chat type
            let requestPromise;
            if (isAnonymous) {
                requestPromise = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$anonymous$2d$chat$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createAnonymousConversation(receiverId);
            } else {
                requestPromise = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chat$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["chatService"].sendChatRequest(receiverId);
            }
...
//# sourceMappingURL=src_10f126e6._.js.map