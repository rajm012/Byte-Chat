...
const developers: Developer[] = [
  ...
  },
  {
    ...
    expertise: ['Express.js', 'Socket.io', 'Real-time Communication', 'Redis'],
    color: 'purple',
  },
];
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-mesh-warm antialiased">
      ...
      <div className="max-w-6xl mx-auto pt-20 sm:pt-24 px-4 pb-12">

        {/* Hero */}
        <div className="text-center mb-8 sm:mb-12 animate-fade-in">
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-3xl bg-linear-to-br from-primary-container via-secondary-container to-tertiary-container mb-4 sm:mb-6 shadow-lg">
            <FiUsers className="w-8 h-8 sm:w-10 sm:h-10 text-on-primary-container" />
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-2 sm:mb-3 text-on-surface">
            Meet Our Team
          </h1>
          <p className="text-sm max-w-lg mx-auto leading-relaxed text-on-surface-variant px-2">
